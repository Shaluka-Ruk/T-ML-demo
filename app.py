        ...
        ui.layout_sidebar(
            ui.sidebar(
                ...
                ui.accordion(
                    ...
                    ui.accordion_panel(
                        "💰 Financial Profile",
                        ui.input_numeric("income", "Annual Income ($)", value=60000, min=0),
                        ui.input_numeric("networth", "Net Worth ($)", value=100000),
                        ui.input_numeric("monthly_debt", "Other Monthly Debt ($)", value=500, min=0),
                        ui.input_numeric("credit_score", "Credit Score (300-850)", value=700, min=300, max=850),
                        value="financial",
                    ),
                    ui.accordion_panel(
                        "🏦 Loan Request",
                        ui.input_numeric("loan_amt", "Loan Amount ($)", value=20000, min=0),
                    ...
                    ui.accordion_panel(
                        ...
                        ui.input_numeric("chk_bal", "Checking Account Balance ($)", value=None),
                        ui.input_numeric("savings_bal", "Savings Account Balance ($)", value=None),
                        ...
                        ui.input_numeric("liabilities", "Total Liabilities ($)", value=None, min=0),
